    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-black sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <header class="font-semibold bg-black text-white border-b-2 border-yellow-300 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                    {{ __('Register') }}
                </header>
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-gray-200 my-6 sm:text-sm sm:my-8">
                            ...
                            <a class="text-yellow-300 hover:text-yellow-200 no-underline hover:underline" href="{{ route('login') }}">
                                {{ __('Login') }}
                            </a>
                        </p>
                    </div>
